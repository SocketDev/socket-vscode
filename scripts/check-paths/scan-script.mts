...
// build/[$][{]<BUILD_MODE|MODE|dev|prod>[}]/<pkg-name>/out/<Final-stage-name>
// — the fully-qualified build output path shape, tolerating shell/Makefile
// variable interpolation (`$MODE`, `${BUILD_MODE}`) in the mode segment.
