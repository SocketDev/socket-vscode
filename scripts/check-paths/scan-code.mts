...
// A quoted string literal — captures (1) the opening quote (`'` or `"`),
// (2) the content, matching escaped chars or any char that isn't the
// closing quote and reusing the opening quote as the closing delimiter.
