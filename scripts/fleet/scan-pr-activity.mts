 ...
 *   - REPLY-WORTHY — you were explicitly pulled in: a review was requested
 *     from you, or you were @-mentioned in a fresh issue/PR. Engage these.
 *   - REVIEW FYI — open, non-draft team PRs whose only commenters are bots
 *     (no teammate has weighed in yet). Look, don't reply unless pulled in.
 * DRAFT PRs are never surfaced. Bot authorship is resolved by the canonical
