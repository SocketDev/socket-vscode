...
| GitHub repo settings         | `scripts/repo/lint-github-settings.mts`                        | Audits visibility, merge settings, branch protection, required apps. Weekly cache-gated; CI doesn't burn API quota                                                                                                        |
